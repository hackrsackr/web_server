...
#define _NAME1 "setpoint-1"
#define _NAME2 "setpoint-2"
#define _NAME3 "setpoint-3"
#define _NAME4 "setpoint-4"

std::array<const char*,  _NUMBER_OF_SPUNDERS> _SETPOINT_NAMES = { _NAME1, _NAME2, _NAME3, _NAME4 };
